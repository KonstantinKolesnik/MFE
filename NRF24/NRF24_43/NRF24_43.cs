...
namespace Gadgeteer.Modules.KKS
{
    ...
    public class NRF24 : GTM.Module
    {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the NRF24 is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="NRF24"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="NRF24"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="NRF24"/></param>
        public delegate void ButtonEventHandler(NRF24 sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="NRF24"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="NRF24"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="NRF24"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(NRF24 sender, ButtonState buttonState)
        {
