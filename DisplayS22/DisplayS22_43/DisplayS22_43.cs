...
namespace Gadgeteer.Modules.KKS
{
    ...
    /// </summary>
    public class DisplayS22 : GTM.Module
    {
        ...
        // GTM.KKS.DisplayS22. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the DisplayS22 module.        
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the DisplayS22 is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="DisplayS22"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="DisplayS22"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="DisplayS22"/></param>
        public delegate void ButtonEventHandler(DisplayS22 sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="DisplayS22"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="DisplayS22"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="DisplayS22"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(DisplayS22 sender, ButtonState buttonState)
        {
